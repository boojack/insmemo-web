...
!(function (A, e) {
  ...
  var s =
    ((o.prototype.get = function (A) {
      ...
      if (0 <= A) {
        ...
        if (A < this.highStart)
          return (
            (e = 2080 + (A >> 11)), (e = this.index[e]), (e += (A >> 5) & 63), (e = ((e = this.index[e]) << 2) + (31 & A)), this.data[e]
          );
  ...
  function Ue(A, e, t) {
    return (
      t < 0 && (t += 1), 1 <= t && (t -= 1), t < 1 / 6 ? (e - A) * t * 6 + A : t < 0.5 ? e : t < 2 / 3 ? 6 * (e - A) * (2 / 3 - t) + A : A
    );
  }
  function le(A) {
    var e = A.filter(kA),
    ...
    PB =
      ...
      (xB.prototype.cloneNode = function (A) {
        ...
        if (e && QB(A) && (wB(A) || uB(A))) {
          ...
          for (
            var s = this.counters.parse(new wn(r)), o = this.resolvePseudoContent(A, t, n, LB.BEFORE), i = A.firstChild;
            i;
            i = i.nextSibling
          )
            (QB(i) &&
          ...
          switch (A.label) {
            ...
            case 13:
              (o = A.sent()),
                e.width &&
                  e.height &&
                  this.ctx.drawImage(o, 0, 0, e.width, e.height, e.bounds.left, e.bounds.top, e.bounds.width, e.bounds.height),
                (A.label = 14);
            case 14:
              if (
                (e instanceof Jn &&
                        ...
                        !(function (A) {
                          ...
                          ? (function (A) {
                            ...
                            (N = (function (A, e, t, r, n) {
                              ...
                              return (
                                Array.isArray(A.size) && ((B = ae(A.size[0], r)), (s = 2 === A.size.length ? ae(A.size[1], n) : B)), [B, s]
                              );
                            })(e, f, p, h, H)),
                            (K = N[0]),
                            (I = N[1]),
      ...
      return S(this, function (A) {
        switch (A.label) {
          ...
          case 5:
            return (
              !0 === Q.removeContainer &&
                (PB.destroy(l) || De.getInstance(r).error("Cannot detach cloned iframe as it is not in the DOM anymore")),
